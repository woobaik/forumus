module ApplicationHelper
    def login_button_helper
        if current_user 
            ...
            (link_to "Log in", new_user_session_path, class:'button login-helper-button is-outlined') +
            (link_to "Sign up", new_user_registration_path, class:'button login-helper-button')
        end    
    end
end
